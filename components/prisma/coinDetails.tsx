            ...
            <div className="max-w-4xl mx-auto mb-8">
                <div className="bg-white dark:bg-gray-800 shadow-sm p-6 mb-6">
                    <div className="flex items-center justify-center space-x-4">
                        ...
                        <div className="text-center">
                            <h1 data-test="coin-name" className="text-3xl font-bold text-gray-900 dark:text-white">
                                {memecoin.name}
                            </h1>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div className="bg-white dark:bg-gray-800 shadow-sm p-6">
                        ...
                        <p data-test="coin-symbol" className="text-2xl font-bold text-gray-900 dark:text-white">
                            {memecoin.symbol}
                        </p>
                    </div>
                    <div className="bg-white dark:bg-gray-800 shadow-sm p-6">
                        ...
                        <p data-test="coin-author" className="text-xl text-gray-900 dark:text-white">
                            {memecoin.author.id == user.id ? <b>Me</b> : memecoin.author.name}
                        </p>
                    </div>
                    <div className="bg-white dark:bg-gray-800 shadow-sm p-6 md:col-span-2">
                        ...
                        <p data-test="coin-desc" className="text-gray-600 dark:text-gray-300 leading-relaxed">
